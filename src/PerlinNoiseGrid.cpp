...
PerlinNoiseGrid::PerlinNoiseGrid(ofVec2f _pos, ofVec2f _gridDimensions, int _xNcells, int _yNcells, ofVec3f _increment, float _zTime, string _name, int _index)
{
    ...
    // It's important to initialize it when we create the PerlinNoiseGrid because it contains
    //  ofVec2f of 'nan' (like ofVec2f(nan, nan)). So it might happen that we apply forces to particles
    //  with nan values, what will make them disappear in the scene since their positions will also become nan
    update();
}
// ==================================================================================
// ==================================================================================
